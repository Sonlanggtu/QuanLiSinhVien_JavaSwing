 ...
 * @author Sonlanggtu
 */
public class AddKhoaFrame extends javax.swing.JFrame {
    Khoa khoa;
    KhoaService khoaService;
    /**
     * Creates new form AddKhoaFrame
     */
    public AddKhoaFrame() {
        khoa = new Khoa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddKhoaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
